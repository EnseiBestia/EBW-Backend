...
<form id="submit_form" action="http://erescue.wabestway.com:8080/CPICRescue/blacklist/create" class="form-horizontal" method="post">
<div class="form-group">
<label class="col-sm-3 control-label"><em>*</em>电话号码：</label>
<div class="col-sm-3">
...
<input id="submit_button" type="button" class="btn btn-primary" value="添加" onclick="window.location.href = &#39;customer_blackList.jsp&#39;;" >
<input type="button" class="btn btn-default" onclick="window.location.href = &#39;customer_blackList.jsp&#39;;" value="返回">
</div>
</form>
</div>
</div>
...
window.location="http://erescue.wabestway.com:8080/blacklist/list";
}
else{
