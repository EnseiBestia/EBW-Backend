...
<div class="container-fluid">
<div class="row">
<div class="col-xs-5" style="width:43%;"><div class="btn-group">
<a class="btn btn-default " href="customer.jsp" tppabs="customer.jsp">用户</a>
<a class="btn btn-default " href="customer_vip.jsp" tppabs="customer_vip.jsp">VIP用户</a>
<a class="btn btn-default " href="customer_blackList.jsp" tppabs="customer_blackList.jsp">黑名单</a>
<a class="btn btn-default active" href="customer_visitRecord.jsp" tppabs="customer_visitRecord.jsp">回访记录</a>
</div>
</div>
<div class="col-xs-7" style="width:57%;">
<form class="form-inline" role="form">
<div class="form-group col-xs-12">
<input class="form-control" id="startTime" name="startTime" placeholder="开始时间" type="text" value="">
<input class="form-control" id="endTime" name="endTime" placeholder="结束时间" type="text" value="">
<input class="form-control" style="width:30%;" name="param" value="" placeholder="输入客户姓名、回访人名称">
