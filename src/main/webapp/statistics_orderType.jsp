...
<h4 class="media-heading">电话中心:</h4>
<h5 class="media-heading" style="margin-top:10PX;">单量:1</h5>
<h5 class="media-heading" style="margin-top:10PX;color:#FF0000;">金额:39</h5>
</div>
</div>
<div class="media-right">
<h5 class="media-heading" style="margin-left:50px;margin-top:10PX;float:left;">单量:33.3%</h5>
<h5 class="media-heading" style="margin-left:30px;margin-top:10PX;float:left;color:#FF0000;">金额:33.3%</h5>
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="media">
<a class="media-left" style="float:left;">
<img src="js/yijianxiadan.png" tppabs="js/yijianxiadan.png" style="float:left;width:70px;height:70px;margin-left:50PX;margin-top:30PX">
</a>
<div class="media-right" style="float:left;margin-top:28PX;margin-left:20PX">
<h4 class="media-heading">撮合:</h4>
<h5 class="media-heading" style="margin-top:10PX;">单量:1</h5>
<h5 class="media-heading" style="margin-top:10PX;color:#FF0000;">金额:39</h5>
</div>
</div>
<div class="media-right">
<h5 class="media-heading" style="margin-left:50px;margin-top:10PX;float:left;">单量:33.3%</h5>
<h5 class="media-heading" style="margin-left:25px;margin-top:10PX;float:left;color:#FF0000;">金额:33.3%</h5>
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="media">
<a class="media-left" style="float:left;">
<img src="js/zizhuyuyue.png" tppabs="js/zizhuyuyue.png" style="float:left;width:70px;height:70px;margin-left:50PX;margin-top:30PX">
</a>
<div class="media-right" style="float:left;margin-top:28PX;margin-left:20PX">
<h4 class="media-heading">一键下单:</h4>
<h5 class="media-heading" style="margin-top:10PX;">单量:1</h5>
<h5 class="media-heading" style="margin-top:10PX;color:#FF0000;">金额:39</h5>
</div>
</div>
<div class="media-right">
<h5 class="media-heading" style="margin-left:50px;margin-top:10PX;float:left;">单量:33.3%</h5>
<h5 class="media-heading" style="margin-left:20px;margin-top:10PX;float:left;color:#FF0000;">金额:33.3%</h5>
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="media">
<a class="media-left" style="float:left;">
<img src="js/qita.png" tppabs="js/qita.png" style="float:left;width:70px;height:70px;margin-left:50PX;margin-top:30PX">
</a>
<div class="media-right" style="float:left;margin-top:28PX;margin-left:20PX">
<h4 class="media-heading">微信:</h4>
<h5 class="media-heading" style="margin-top:10PX;">单量:0</h5>
<h5 class="media-heading" style="margin-top:10PX;color:#FF0000;">金额:0</h5>
</div>
</div>
<div class="media-right">
<h5 class="media-heading" style="margin-left:50px;margin-top:10PX;float:left;">单量:0%</h5>
<h5 class="media-heading" style="margin-left:40px;margin-top:10PX;float:left;color:#FF0000;">金额:0%</h5>
</div>
</div>
</div>
</div>
