...
<div class="btn-group">
<a class="btn btn-default active" href="customer.jsp" tppabs="customer.jsp">用户</a>
...
<button class="pull-right button button-rounded button-flat-blue" onclick="window.location=&#39;customer_add.jsp&#39;;"><i class="icon-plus"></i>&nbsp;添加新客户</button>
</div>
</div>
...
<td>
<a href="customer_add.jsp" tppabs="customer_add.jsp" class="btn-link">编辑</a>
