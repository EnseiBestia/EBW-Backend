...
<form class="form-horizontal" id="submit_form" action="http://erescue.wabestway.com:8080/CPICRescue/member/createVip" method="post">
...
<div class="col-sm-3">
<input id="submit_button" type="button" class="btn btn-primary" value="保存" onclick="window.location.href = 'customer.jsp.htm'/*tpa=customer.jsp*/" >
<input type="button" class="btn btn-default" onclick="window.location.href = 'customer.jsp.htm'/*tpa=customer.jsp*/" value="返回">
</div>
</div>
</form>
</div>
