...
<a class="btn btn-default active" href="customer_vip.jsp" tppabs="customer_vip.jsp">VIP用户</a>
<a class="btn btn-default" href="customer_blackList.jsp" tppabs="customer_blackList.jsp">黑名单</a>
<a class="btn btn-default" href="customer_visitRecord.jsp" tppabs="customer_visitRecord.jsp">回访记录</a>
</div>
</div>
...
<input type="text" class="form-control" style="width:80%;" name="param" value="" placeholder="输入联系人、客户来源、手机号、车牌号">
</div>
<button type="submit" class="btn btn-default"><i class="icon-search"></i>&nbsp;搜索</button>
</form>
</div>
<div class="col-xs-2" style="width:14%;">
<button class="pull-right button button-rounded button-flat-blue" onclick="window.location=&#39;customer_vip_add.jsp&#39;;"><i class="icon-plus"></i>&nbsp;添加新客户</button>
</div>
</div>
...
<td>
<a href="customer_vip_add.jsp" tppabs="customer_vip_add.jsp" class="btn-link">编辑</a>
<a href="javascript:;" data-value="838" class="btn-link deletethis">删除</a>
<a href="customer_visitRecord.jsp" tppabs="customer_visitRecord.jsp" class="btn-link">回访记录</a>
<a href="javascript:;" class="btn-link" onclick="window.open(&#39;customer_visit.jsp&#39;, &#39;_blank&#39;, &#39;height=650,width=1024,scrollbars=yes,resizable=yes,alwaysRaised=yes,toolbar=no&#39;);">回访</a>
</td>
</tr>
</tbody>
</table>
