...
<p></p>
<p>
<button href="javascript:;" class="btn btn-primary" id="photo_upload_dialog">上传协议</button>
</p>
</div>
</div>
</div>
...
<div class="panel-body">
<div class="form-group">
<label for="username"><em>*</em>服务商名称：</label>
<input class="form-control" id="username" name="username" type="text" value="" pattern=".{2,}" required="" placeholder="名称为5-20个字符" title="名称为5-20个字符">
</div>
<div class="form-group">
<label for="name"><em>*</em>服务地域：</label>
<input class="form-control" id="name" name="name" type="text" value="" required="" placeholder="填写服务地域">
</div>
<div class="form-group">
<label for="name"><em>*</em>服务时段：</label>
<input class="form-control" id="realname" name="realname" type="text" value="" required="" placeholder="填写服务时段">
</div>
<div class="form-group">
<label for="idCard"><em>*</em>服务项目：</label>
<input class="form-control" id="idCard" name="idCard" type="text" value="" required="" placeholder="填写服务项目">
</div>
<div class="form-group">
<label for="phone"><em>*</em>联系人：</label>
<input class="form-control" id="phone" name="phone" type="text" value="" required="" placeholder="填写联系人">
</div>
<div class="form-group">
<label for="phone"><em>*</em>联系人手机号：</label>
<input class="form-control" id="phone" name="phone" type="text" value="" required="" placeholder="联系人手机号">
</div>
<div class="form-group">
<label for="licenseTime"><em>*</em>协议到期时间：</label>
<input class="form-control" id="licenseTime" name="licenseTime" type="text" required="" readonly="">
</div>
<div class="form-group" style="margin-left:10px;">
<input id="submit_button" type="button" class="btn btn-primary" value="保存" onclick="window.location.href = &#39;vendor.jsp&#39;;">
<input type="button" class="btn btn-default" onclick="window.location.href = &#39;vendor.jsp&#39;;" value="返回">
</div>
</div>
</div>
</div>
...
<div class="form-group" style="margin-left:10px;">
<input id="submit_button" type="button" class="btn btn-primary" value="添加新车辆" onclick="window.location.href = &#39;vendor.jsp&#39;;">
<input id="submit_button" type="button" class="btn btn-primary" value="添加新救援人员" onclick="window.location.href = &#39;driver_add.jsp&#39;;">
<input id="submit_button" type="button" class="btn btn-primary" value="添加价目" onclick="window.location.href = &#39;system_chargeSetting.jsp&#39;;">
</div>
</div>
</div>
</div>
