...
<a class="btn btn-default active" href="customer_blackList.jsp" tppabs="customer_blackList.jsp">黑名单</a>
...
<input type="text" class="form-control" name="param" value="" placeholder="输入电话号码">
</div>
<button type="submit" class="btn btn-default"><i class="icon-search"></i>&nbsp;搜索</button>
</form>
</div>
<div class="col-xs-2">
<button class="pull-right button button-rounded button-flat-blue" onclick="window.location=&#39;customer_blackList_add.jsp&#39;;"><i class="icon-plus"></i>&nbsp;添加黑名单</button>
</div>
</div>
...
<td>骚扰</td>
<td>
<a href="customer_blackList_add.jsp" tppabs="customer_blackList_add.jsp" class="btn-link editthis">编辑</a>
<a href="javascript:;" data-value="1" class="btn-link deletethis">删除</a>
</td>
</tr>
</tbody>
</table>
...
$.post('/blacklist/delete',{'id':thisButton.attr("data-value")},function(data){
if(data.success){
