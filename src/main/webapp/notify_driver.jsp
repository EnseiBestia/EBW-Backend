...
<td>你好</td>
<td>em</td>
<td>2015/01/11 00:50</td>
<td>
<a href="notify_add.jsp" tppabs="notify_add.jsp" class="btn-link">编辑</a>
<a href="javascript:;" data-value="65" class="btn-link deletethis">删除</a>
</td>
</tr>
</tbody>
</table>
...
$.post('/notice/delete',{'id':thisButton.attr("data-value")},function(data){
if(data.success){
thisButton.parent().parent().remove();
$.scojs_message('通知删除成功', $.scojs_message.TYPE_OK);
} else {
