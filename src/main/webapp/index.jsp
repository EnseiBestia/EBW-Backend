...
<small>
<span>试用平台</span>
<a href="http://www.wabestway.com">华焱坤泰</a><span>，欢迎回来！ &nbsp;&nbsp;</span>
...
<p style="padding-top:6px;">距离下次刷新还有：<font color="red" id="refresh_time">30</font>秒</p>
</div>
</div>
<div class="col-xs-5">
...
<tr>
<td><a href="order_detail_uncomplete.jsp" tppabs="order_detail_uncomplete.jsp" class="btn-link">***01110003</a></td>
<td>一键下单</td>
<td>微信</td>
<td>01/10 19:36</td>
<td style="max-width:300px;">永安里</td>
<td>先生/女士</td>
<td>18611786726</td>
<td></td>
<td>
<a class="btn-link" href="distribute.jsp" tppabs="distribute.jsp">派单</a>
<a href="javascript:;" data-value="3067" class="btn-link cancelthis">销单</a>
<a href="javascript:;" data-value="3067" data-value-memo="" class="btn-link memothis">备注</a>
</td>
</tr>
<tr>
<td><a href="order_detail_uncomplete.jsp" tppabs="order_detail_uncomplete.jsp" class="btn-link">***01110002</a></td>
<td>撮合</td>
<td>APP</td>
<td>01/10 19:36</td>
<td style="max-width:300px;">永安里</td>
...
<td>
<a class="btn-link" href="distribute.jsp" tppabs="distribute.jsp">派单</a>
<a href="javascript:;" data-value="3066" class="btn-link cancelthis">销单</a>
<a href="javascript:;" data-value="3066" data-value-memo="" class="btn-link memothis">备注</a>
</td>
</tr>
<tr>
<td><a href="order_detail_uncomplete.jsp" tppabs="order_detail_uncomplete.jsp" class="btn-link">***01110001</a></td>
<td>一键下单</td>
<td>电话中心</td>
<td>01/10 19:36</td>
<td style="max-width:300px;">永安里</td>
...
<td>
<a class="btn-link" href="distribute.jsp" tppabs="distribute.jsp">派单</a>
<a href="javascript:;" data-value="3065" class="btn-link cancelthis">销单</a>
<a href="javascript:;" data-value="3065" data-value-memo="" class="btn-link memothis">备注</a>
</td>
</tr>
</tbody></table>
</div>
...
<tr>
<td><a href="order_detail.jsp" tppabs="order_detail.jsp" class="btn-link">***01110007</a></td>
<td>一键下单</td>
<td>APP</td>
<td>01/11 00:44</td>
<td style="max-width:280px;">滨惠北三街</td>
<td></td>
<td>12522225525</td>
<td>
测试
...
<td>
<a href="javascript:;" data-value="3071" class="btn-link powercancelthis">强制销单</a>
<a href="javascript:;" data-value="3071" class="btn-link powerrevokethis">强制收回</a>
<a href="javascript:;" data-value="3071" data-value-memo="" class="btn-link memothis">备注</a>
</td>
</tr>
</tbody></table>
</div>
...
<td>滨惠北三街</td>
<td>01-11 00:51</td>
<td><a href="order_detail.jsp" tppabs="order_detail.jsp" class="btn-link">
***01110053</a>
</td>
<td>张三(安联)</td>
<td>
...
<button type="button" class="btn btn-primary" id="ok_modal_cancel" action="javascript:if(confirm('http://erescue.wabestway.com:8080/order/cancelpost  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://erescue.wabestway.com:8080/order/cancelpost'" tppabs="http://erescue.wabestway.com:8080/order/cancelpost">提交</button>
...
<div class="form-group">
<div class="col-sm-12">
<textarea class="form-control" cols="20" id="dialog_powercancel_content" name="content" rows="2" required=""></textarea>
</div>
</div>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-primary" id="ok_modal_powercancel" action="javascript:if(confirm('http://erescue.wabestway.com:8080/order/powercancelpost  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://erescue.wabestway.com:8080/order/powercancelpost'" tppabs="http://erescue.wabestway.com:8080/order/powercancelpost">提交</button>
...
<div class="modal-footer">
<button type="button" class="btn btn-primary" id="ok_modal_revoke" action="javascript:if(confirm('http://erescue.wabestway.com:8080/order/revokepost  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://erescue.wabestway.com:8080/order/revokepost'" tppabs="http://erescue.wabestway.com:8080/order/revokepost">提交</button>
...
<div class="modal-footer">
<button type="button" class="btn btn-primary" id="ok_modal_powerrevoke" action="javascript:if(confirm('http://erescue.wabestway.com:8080/order/powerrevokepost  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://erescue.wabestway.com:8080/order/powerrevokepost'" tppabs="http://erescue.wabestway.com:8080/order/powerrevokepost">提交</button>
...
<div class="modal-footer">
<button type="button" class="btn btn-primary" id="ok_modal_memo" action="javascript:if(confirm('http://erescue.wabestway.com:8080/order/memopost  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://erescue.wabestway.com:8080/order/memopost'" tppabs="http://erescue.wabestway.com:8080/order/memopost">提交</button>
...
<p>
如果您习惯于用IE浏览器，强烈建议您升级到 <a href="javascript:if(confirm('http://windows.microsoft.com/zh-cn/internet-explorer/ie-10-worldwide-languages  \n\nτ¼��Teleport Pro ȡ»أ¬ӲΪ ̼µœ򼳂·¾¶³¬¹��ʨ׃µķ¶Χ¡£  \n\nţҪ´ӷ�ϴ򿫋�))window.location='http://windows.microsoft.com/zh-cn/internet-explorer/ie-10-worldwide-languages'" tppabs="http://windows.microsoft.com/zh-cn/internet-explorer/ie-10-worldwide-languages" title="" data-original-title="点击下载升级">最新的IE浏览器(10+)</a>
...
<script src="js/orderrealtime.js" tppabs="js/orderrealtime.js"></script>
